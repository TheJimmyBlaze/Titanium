...
export const useKeyInput = () => {
    ...
    const keyDown = e => {
        ...
        Object.values(keyDownCallbacks).forEach(callback => callback(e));

        if (
            Object.keys(keyDownCallbacks).length +
            Object.keys(keyPressCallbacks).length > 0
        ) return;
    ...
    const keyPress = e => {
        Object.values(keyPressCallbacks).forEach(callback => callback(e));
    };
