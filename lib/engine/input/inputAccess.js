...
export const useInputAccess = () => {
    ...
    return {
        ...
        registerKeyDown: keyInput.registerKeyDown,
        registerKeyPress: keyInput.registerKeyPress,
        deregisterKeyDown: keyInput.deregisterKeyDown,
        deregisterKeyPress: keyInput.deregisterKeyPress
    };
};