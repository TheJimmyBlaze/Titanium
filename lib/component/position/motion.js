...
export const useMotion = ({
    ...
    const getAcceleration = () => ({ x: state.accelerationX, y: state.accelerationY});
    const setAcceleration = (x, y) => { state.accelerationX = x; state.accelerationY = y; };

    const getDrag = () => ({ x: state.dragX, y: state.dragY });
    ...
    const getPotential = () => ({ x: state.potentialX, y: state.potentialY });
    const setPotential = (x, y) => { state.potentialX = x, state.potentialY = y; };
    
    const getVelocity = () => ({ x: state.velocityX, y: state.velocityY });
    const setVelocity = (x, y) => { state.velocityX = x, state.velocityY = y; };
