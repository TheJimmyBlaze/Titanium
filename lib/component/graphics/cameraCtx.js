...
import { CANVAS_TYPE_CTX } from './canvasCtx';

export const CAMERA_TYPE_CTX = "titanium.camera.ctx";

export const useCameraCtx = ({
    canvas,
    ...
    if (canvas.type !== CANVAS_TYPE_CTX) throw new Error('cameraCtx requires canvasCtx');
