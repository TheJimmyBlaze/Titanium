...
export const useCamera = ({
    ...
    const replicas = {};
    const addReplica = replica => replicas[replica.id] = replica;
    const removeReplica = id => delete replicas[id];
    ...
    const commit = () => {
        ...
        drawOrder.forEach(zIndex => {
            ...
            while (queue.length > 0) {
                ...
                queue[0](ctx);
                Object.values(replicas).forEach(replica => replica.requestDraw(queue[0]));
